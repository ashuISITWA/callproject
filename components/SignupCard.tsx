        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              id="terms"
              required
              className="w-4 h-4 rounded border-zinc-300 dark:border-zinc-700 text-slate-600 focus:ring-slate-500 bg-zinc-50 dark:bg-zinc-800/50"
            />
            <label className="text-sm text-zinc-600 dark:text-zinc-400">
              {t("termsAgreement")}{" "}
              <Link
                href="#"
                className="text-blue-600 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-500"
              >
                {t("termsText")}
              </Link>
            </label>
